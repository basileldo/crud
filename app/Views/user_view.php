...
<html>
  ...
  $(document).ready( function () {
    ...
    function edit_user(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('public/index.php/user/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('public/index.php/user/user_add')?>";
      }
      else
      {
        url = "<?php echo site_url('public/index.php/user/user_update')?>";
      }
    ...
    function delete_user(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data from database
          $.ajax({
            url : "<?php echo site_url('public/index.php/user/user_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
